...
avPlots(model1, col.lines = "red", id = FALSE)
...
avPlots(model2, col.lines = "red", id = FALSE)
...
avPlots(model3, col.lines = "red", id = FALSE)
...
avPlots(fertxlabor1, col.lines = "red", id = FALSE)
...
avPlots(fertxlabor2, col.lines = "red", id = FALSE)
...
avPlots(model4, col.lines = "red", id = FALSE)
